...
for(l in 1:length(break_locations)){
  ...
  for(i in 1:trials){
    ...
    #if(n*break_locations[l]>=7 &&
    #   n*(1-break_locations[l])>=7) {
      gSeg_MDT7 <- gseg1_new(n, MDT7, pval.perm = T, pval.appr = F)
    # } else{
    #   gSeg_MDT7 <- list()
    #   gSeg_MDT7$pval.perm$ori$pval <- NA
    #   gSeg_MDT7$pval.perm$weighted$pval <- NA
    #   gSeg_MDT7$pval.perm$max.type$pval <- NA
    #   gSeg_MDT7$pval.perm$generalized$pval <- NA
    # }
    # if(n*break_locations[l]>=15 &&
    #    n*(1-break_locations[l])>=15) {
    ...
    # } else{
    #   gSeg_NNL7 <- list()
    #   gSeg_NNL7$pval.perm$ori$pval <- NA
    #   gSeg_NNL7$pval.perm$weighted$pval <- NA
    #   gSeg_NNL7$pval.perm$max.type$pval <- NA
    #   gSeg_NNL7$pval.perm$generalized$pval <- NA
    # }
    # if(n*break_locations[l]>=15 &&
    #    n*(1-break_locations[l])>=15) {
    ...
    # } else{
    #   gSeg_MST7 <- list()
    #   gSeg_MST7$pval.perm$ori$pval <- NA
    #   gSeg_MST7$pval.perm$weighted$pval <- NA
    #   gSeg_MST7$pval.perm$max.type$pval <- NA
    #   gSeg_MST7$pval.perm$generalized$pval <- NA
    # }
    # if(n*break_locations[l]>=15 &&
    #    n*(1-break_locations[l])>=15) {
