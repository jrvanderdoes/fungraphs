...
change_locs <- c(60,110,30)
meanValues<- c(0,0.75,0)
distValues <- c('Normal','Normal','Normal')
eigMults <- c(1,1,1)
...
saveRDS(data_list,file =paste0(path,"\\data\\mult_mean.rds"))
saveRDS(mst5_pts,file = paste0(path,"\\results\\mult_mean_mst.rds"))
saveRDS(mdt5_pts,file = paste0(path,"\\results\\mult_mean_mdt.rds"))
saveRDS(nnl5_pts,file = paste0(path,"\\results\\mult_mean_nnl.rds"))
saveRDS(mean_pts,file = paste0(path,"\\results\\mult_mean_mean.rds"))
...
data_plot <- data.frame(type='MDT-5',
                        pts=readRDS(paste0(path,"\\results\\mult_mean_mdt.rds")))
data_plot <- rbind(data_plot,
                   data.frame(type='NNL-5',
                              pts=readRDS(paste0(path,"\\results\\mult_mean_nnl.rds"))))
data_plot <- rbind(data_plot,
                   data.frame(type='MST-5',
                              pts=readRDS(paste0(path,"\\results\\mult_mean_mst.rds"))))
data_plot <- rbind(data_plot,
                   data.frame(type='ARS-18',
                              pts=readRDS(paste0(path,"\\results\\mult_mean_mean.rds"))))
...
png(paste0(path, '//figures//MultipleChange_mean.png'),
